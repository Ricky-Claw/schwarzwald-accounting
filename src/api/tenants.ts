...
import { acceptInvite, createInvite, ensureDefaultTenant, getTenantContext, listTenants } from '../services/tenant.service.js';
...
router.post('/invites', async (req, res) => {
  try {
    ...
    const ctx = await getTenantContext(userId, req.body.tenant_id);
