...
export default function SettingsPage() {
  ...
  if (!tenant) return <div className="min-h-screen bg-slate-50 p-8">Lade Firmendaten...</div>;

  return <div className="min-h-screen bg-slate-50">
    <header className="bg-white border-b border-slate-200"><div className="max-w-4xl mx-auto px-6 py-4">
